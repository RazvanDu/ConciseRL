    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.vllm_engines is not None and torch.distributed.get_rank() == 0:
            ...
            print("VVV3", master_address, master_port)
...
class ActorModelRayActor(BasePPORole):
    def init_model_from_pretrained(self, strategy: DeepspeedStrategy, pretrain):
        ...
        if args.scheduler_type == 'cosine':
            ...
            actor_scheduler = get_scheduler(
                ...
                actor_optim,
                num_warmup_steps=min(math.ceil(max_steps * args.lr_warmup_ratio), 10),
                num_training_steps=max_steps
            )
    ...
    def prepare_datasets(self):
        ...
        self.prompts_dataset = PromptDataset(
            prompts_data, self.tokenizer, strategy, input_template=args.input_template, system_prompt=args.system_prompt
        )
        def collate_fn(data):
